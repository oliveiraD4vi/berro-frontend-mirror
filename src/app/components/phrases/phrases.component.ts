...
export class PhrasesComponent {
  phrases = [
    {
      "phrase": "O sucesso é uma combinação perfeita de dedicação, persistência e paixão.",
    ...
    {
      "phrase": "A felicidade está nas pequenas coisas, basta aprendermos a apreciá-las.",
      "author": "Autor Desconhecido"
    },
    {
    ...
    {
      "phrase": "Educação nunca foi despesa. Sempre foi investimento com retorno garantido.",
    ...
    {
      "phrase": "Deus, para a felicidade do homem, inventou a fé e o amor. O Diabo, invejoso, fez o homem confundir fé com religião e amor com casamento.",
      "author": "Machado de Assis"
    },
    {
    ...
    {
      "phrase": "Todos estamos matriculados na escola da vida, onde o mestre é o tempo.",
      "author": "Cora Coralina"
    },
    {
      "phrase": "Quando as coisas ficam ruins, é sinal de que as coisas boas estão por perto.",
      "author": "Cora Coralina"
    },
    {
    ...
    {
      "phrase": "Se você tem conhecimento, deixe os outros acenderem as suas velas nele.",
